...
<html lang="en">
    <head>
        ...
        <title>{{$title}} E| Ecom-Ecomerce</title>
    ...
    <body>
        ...
        <footer id="footer"><!--Footer-->
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="row">
                        <p class="pull-left">Copyright © {{date('Y')}} Ecom-Ecomerce. All rights reserved.</p>
                        <p class="pull-right">Laravel implementation by <span><a target="_blank" href="http://http://www.pentabits.net/">Pentabits</a></span> </p>
                    </div>
                </div>
            </div>
